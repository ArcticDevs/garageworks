    ...
    <div className="pb-5 ">
     ...
     <button
        ...
        <input
          ...
          value={number}
        />
        <button type="button" className="btn col-2" data-bs-toggle="tooltip" data-bs-placement="top" title=" *Alternate contact is helpful in case they are not reachable at time
          of service">
  !
</button>
        ...
        <div className={styles.address_form}>
          ...
          <div className="my-4">{/* <Map userAddress={userLocation} /> */}</div>
