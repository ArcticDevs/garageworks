...
const Locate = () => {
  ...
  const addresses = [
    {locality : "Parshva Complex, Ellora Park" , city : "Vadodara" , pincode : "3900001"},
    {locality : "Nagdevi Street, Nagdevi" , city : "Mumbai" , pincode : "400003"},
    {locality : "Parking lot no.2, Pune Airport" , city : "Pune" , pincode : "382007"}
  ];
          ...
          {addresses.map((curr, index) => (
            <div key={index}>
              ...
              >
                ...
                <span>{`${curr.locality}, ${curr.city}, ${curr.pincode}`}</span>{" "}
              </h4>
